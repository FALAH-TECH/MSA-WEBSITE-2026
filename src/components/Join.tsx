  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6 lg:px-8">
        <MotionSection className="text-center mb-12" slideOffset={24}>
        ...
        <MotionSection as="div" className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 md:p-12 mb-12" slideOffset={24}>
        ...
        <MotionSection className="text-center" slideOffset={0}>
